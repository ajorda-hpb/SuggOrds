...
create table ReportsView.dbo.ngXacns_SetAdjs
	...
	,constraint PK_ngXacnsSetAdjs primary key(Loc,ItemCode,Item,crSet,nxIn))
--create nonclustered index idx_ngXacnsSetAdjs_Loc on ReportsView.dbo.ngXacns_SetAdjs(Loc) include(ItemCode,Item,crSet,nxIn,nAdjQ,fAdjQ)
*/
