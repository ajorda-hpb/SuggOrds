...
where Rord <> 'NN'
    ...
    ,'IDTOYSMITH','IDUNEMPLOY','IDUSPLAYIN','IDWISHPETS','IFDISCONFO','IFPROPERRE') 
...
insert into #ExcelGrps values ('IDBENDONPU','Kids'),('IDBKSALESI','BSI'),('IDBOOKDEPO','BSI'),('IDBRYBELLY','Kids')
    ...
    ,('IFDISCONFO','Media'),('IFPROPERRE','Media'),('IFWORDSWOR','misc'),('IDAURORA','Kids'),('IDWISHPETS','Kids')
...
insert into #VendorParams values 
    ...
    ,('IDWISHPETS',84,31,90,0),('IFDISCONFO',180,60,210,0),('IFPROPERRE',180,60,210,0)
