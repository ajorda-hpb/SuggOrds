...
where Rord <> 'NN'
    ...
    ,'IDTOYSMITH','IDUNEMPLOY','IDUSPLAYIN','IDWISHPETS','IFDISCONFO','IFPROPERRE','IDMAKEITRE','IDGIANTMIC','IFFATCAT','IDUSMEDIAP') 
...
insert into #ExcelGrps values ('IDBENDONPU','Kids'),('IDBKSALESI','BSI'),('IDBOOKDEPO','BSI'),('IDBRYBELLY','Kids')
    ...
    ,('IFDISCONFO','Media'),('IFPROPERRE','Media'),('IFWORDSWOR','misc'),('IDAURORA','Kids'),('IDWISHPETS','Kids'),('IDMAKEITRE','Kids')
    ,('IDGIANTMIC','Kids'),('IFFATCAT','Media'),('IDUSMEDIAP','BSI')
...
insert into #VendorParams values 
    ...
    ,('IFFATCAT',180,60,210,0),('IDUSMEDIAP',84,31,90,0)
